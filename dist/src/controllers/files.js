...
const web3StorageUpload = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fileName = `${(0, utils_1.toBytes32)(new Date().getTime().toString() + '_' + reqFile.originalname)}`;
    const file = yield (0, storage_1.fileFromPath)(reqFile, fileName);
    const fileCid = yield (0, storage_1.storeFiles)(file);
    const files = yield (0, storage_1.makeFileObjects)(fileName, `https://${fileCid}.ipfs.w3s.link/${fileName}`);
